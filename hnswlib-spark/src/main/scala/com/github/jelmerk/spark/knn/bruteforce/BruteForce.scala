...
object BruteForceModel extends MLReadable[BruteForceModel] {
  ...
  private[knn] class BruteForceModelReader extends KnnModelReader[BruteForceModel, String, Array[Float], DenseVectorIndexItem, BruteForceIndex[String, Array[Float], DenseVectorIndexItem, Float]] {
...
class BruteForceModel private[bruteforce](override val uid: String,
  ...
  extends DenseVectorKnnModel[BruteForceModel, BruteForceIndex[String, Array[Float], DenseVectorIndexItem, Float]](uid, indices) with MLWritable {
...
/**
  ...
  * @param uid identifier
  */
class BruteForce(override val uid: String) extends DenseVectorKnnAlgorithm[BruteForceModel, BruteForceIndex[String, Array[Float], DenseVectorIndexItem, Float]](uid)  {

  def this() = this(Identifiable.randomUID("brute_force"))

  override def createIndex(dimensions: Int, maxItemCount: Int): BruteForceIndex[String, Array[Float], DenseVectorIndexItem, Float] =
    BruteForceIndex[String, Array[Float], DenseVectorIndexItem, Float](dimensions, distanceFunctionByName(getDistanceFunction))
