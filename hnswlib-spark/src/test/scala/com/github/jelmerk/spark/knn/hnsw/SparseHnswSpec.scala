...
//
//    val ds = Seq(
//      InputRow(1000000, Vectors.sparse(2, Array(0,1), Array(0.0110f, 0.2341f))),
//      InputRow(2000000, Vectors.sparse(2, Array(0,1), Array(0.2300f, 0.3891f))),
//      InputRow(3000000, Vectors.sparse(2, Array(0,1), Array(0.4300f, 0.9891f)))
//    ).toDS()
//
//    val normalizer = new Normalizer()
//      .setInputCol("vector")
//      .setOutputCol("vector_normalized")
//
//    val normalized = normalizer.transform(ds)
//      .drop("vector")
//      .withColumnRenamed("vector_normalized", "vector")
//      .as[InputRow[Int, DenseVector]]
//      .collect()
//
...
//
//      // 0.11621313074466955
//      DistanceFunctions.innerProduct(normalized(0).vector, normalized(1).vector)
//    )
//
//  }
//
...
//
//    println(
//      knn.DistanceFunctions.DOUBLE_COSINE_DISTANCE.distance(Array(0.0110f, 0.2341f), Array(0.2300f, 0.3891f))
//
//      // 0.11621313074466944
//    )
//
