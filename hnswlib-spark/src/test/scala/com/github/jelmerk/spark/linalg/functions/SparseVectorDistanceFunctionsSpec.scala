...
class SparseVectorDistanceFunctionsSpec extends FunSuite {
  ...
  test("calculate inner product") {
    ...
    SparseVectorDistanceFunctions.innerProductDistance(a, b) should be(0.11602999999999997)
  }
  ...
  test("calculate inner product with empty positions") {
    ...
    SparseVectorDistanceFunctions.innerProductDistance(a, b) should be(0.09999999999999998)
  }
  ...
  test("calculate cosine distance") {
    ...
    SparseVectorDistanceFunctions.cosineDistance(a, b) should be(0.2857142857142858)
  }
  ...
  test("calculate cosine distance with empty positions") {
    ...
    SparseVectorDistanceFunctions.cosineDistance(a, b) should be(0.21812996302647503)
  }
