...
/**
  ...
  */
@SerialVersionUID(1L)
private[scala] class JavaIndexAdapter[TId, TVector, TItem <: Item[TId, TVector], TDistance](val delegate: Index[TId, TVector, TItem, TDistance])
  extends core.Index[TId, TVector, TItem, TDistance] {
  ...
  override def findNearest(vector: TVector, k: Int): JList[core.SearchResult[TItem, TDistance]] =
  ...
  override def findNeighbors(id: TId, k: Int): JList[core.SearchResult[TItem, TDistance]] = delegate.findNeighbors(id, k).asJava
