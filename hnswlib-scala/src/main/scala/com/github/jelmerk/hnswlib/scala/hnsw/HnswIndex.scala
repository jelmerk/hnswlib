...
import com.github.jelmerk.hnswlib.core.JavaObjectSerializer

import java.io.{File, InputStream}
import java.nio.file.Path
import com.github.jelmerk.hnswlib.core.hnsw.{HnswIndex => JHnswIndex}
...
object HnswIndex {
  ...
  /**
    ...
    */
  def loadFromInputStream[TId,  TVector, TItem <: core.Item[TId, TVector], TDistance](inputStream: InputStream,
  ...
  /**
    ...
    * @return The restored index
    */
  def loadFromFile[TId,  TVector, TItem <: core.Item[TId, TVector], TDistance](file: File,
                                                                               classLoader: ClassLoader = Thread.currentThread.getContextClassLoader)
  ...
  /**
    ...
    * @return The restored index
    */
  def loadFromPath[TId,  TVector, TItem <: core.Item[TId, TVector], TDistance](path: Path,
                                                                               classLoader: ClassLoader = Thread.currentThread.getContextClassLoader)
    : HnswIndex[TId, TVector, TItem, TDistance] =
  ...
  /**
    ...
    * @return the index
    */
  def apply[TId,  TVector, TItem <: core.Item[TId, TVector], TDistance](
                                                                         dimensions: Int,
                                                                         ...
                                                                         itemIdSerializer: core.ObjectSerializer[TId] = new JavaObjectSerializer[TId],
                                                                         itemSerializer: core.ObjectSerializer[TItem] = new JavaObjectSerializer[TItem])(implicit distanceOrdering: Ordering[TDistance])
      : HnswIndex[TId, TVector, TItem, TDistance] = {
   ...
   * @return the index
   */
  def empty[TId,  TVector, TItem <: core.Item[TId, TVector], TDistance]: HnswIndex[TId, TVector, TItem, TDistance] = {
...
/**
  ...
  */
@SerialVersionUID(1L)
class HnswIndex[TId, TVector, TItem <: core.Item[TId, TVector], TDistance] private(delegate: JHnswIndex[TId, TVector, TItem, TDistance])
  ...
  /**
    ...
    */
  val itemIdSerializer: core.ObjectSerializer[TId] = delegate.getItemIdSerializer

  /**
    * The serializer used to serialize items when saving the index
    */
  val itemSerializer: core.ObjectSerializer[TItem] = delegate.getItemSerializer
